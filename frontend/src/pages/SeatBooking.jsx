...
const SeatBooking = () => {
  ...
  const fetchSeats = async () => {
    try {
      ...
      const response = await axios.get('https://railwaybooking.onrender.com/api/seats');
  ...
  const initializeSeats = async () => {
    try {
      ...
      const response = await axios.post('hhttps://railwaybooking.onrender.com/api/seats/init');
  ...
  const handleBooking = async () => {
    ...
    try {
      const response = await axios.post('https://railwaybooking.onrender.com/api/bookings', {
